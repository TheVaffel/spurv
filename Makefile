...
HDRS=declarations.hpp types.hpp nodes.hpp expressions.hpp shader.hpp spurv.hpp uniform.hpp constant_registry.hpp

SRCS=types.cpp uniform.cpp constant_registry.cpp
